...
PBL_APP_INFO(MY_UUID, "FuzzyZeit", "Jonas Zimmermann", 0x4, 0x0, RESOURCE_ID_IMAGE_MENU_ICON, APP_INFO_WATCH_FACE /* App version */);

char *myHours[12] = {"Zwölf", "Eins", "Zwei", "Drei", "Vier", "Fünf", "Sechs", "Sieben", "Acht", "Neun", "Zehn", "Elf"};
